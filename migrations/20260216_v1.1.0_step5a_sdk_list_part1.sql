...
SET sdk_list = '[
  {
    ...
    "company": "高德软件有限公司",
    "purpose": "提供定位服务",
    "dataCollected": ["精确/粗略位置信息","WIFI信息（SSID、BSSID）","基站信息","IP地址","GNSS信息","设备标识信息（IMEI、IDFA、IDFV、Android ID、MEID、MAC地址、OAID、IMSI、硬件序列号）","设备型号","操作系统","运营商信息"],
  ...
  },
  {
    ...
    "company": "高德软件有限公司",
    "purpose": "提供地图显示和交互功能",
    "dataCollected": ["位置信息","WIFI列表","设备标识信息（IMEI、Android ID、MAC地址、OAID）","设备型号"],
    "privacyUrl": "https://lbs.amap.com/pages/privacy/"
  },
  {
    "name": "微信OpenSDK",
    ...
    "purpose": "微信登录和分享功能",
    "dataCollected": ["设备标识信息（Android ID、MAC地址）","已安装应用列表（判断微信安装状态）"],
  ...
  },
  {
    ...
    "purpose": "即时通信服务",
    "dataCollected": ["设备型号","操作系统版本","设备标识信息（Android ID、MAC地址）","网络状态","存储信息"],
