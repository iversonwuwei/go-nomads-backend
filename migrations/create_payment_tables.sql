...
CREATE TABLE IF NOT EXISTS public.orders (
    ...
    -- 第三方支付信息（PayPal / WeChat Pay / Alipay 等）
    external_payment_order_id VARCHAR(100) NULL,
    external_payment_id VARCHAR(100) NULL,
    external_payer_id VARCHAR(100) NULL,
    external_payer_email VARCHAR(255) NULL,
...
COMMENT ON COLUMN public.orders.external_payment_order_id IS '第三方支付订单ID';
COMMENT ON COLUMN public.orders.external_payment_id IS '第三方支付确认/交易ID';
