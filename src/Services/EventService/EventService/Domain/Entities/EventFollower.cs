...
public class EventFollower : BaseModel
{
    ...
    [Required] [Column("event_id")] public Guid EventId { get; private set; }

    [Required] [Column("user_id")] public Guid UserId { get; private set; }

    [Column("followed_at")] public DateTime FollowedAt { get; private set; }

    [Column("notification_enabled")] public bool NotificationEnabled { get; private set; }
