...
{
    [JsonIgnore] public string CityId { get; set; } = string.Empty;
...
public class UpsertCityReviewRequest
{
    ...
    [Range(1, 5)] public int? InternetQualityScore { get; set; }

    [Range(1, 5)] public int? SafetyScore { get; set; }

    [Range(1, 5)] public int? CostScore { get; set; }
