...
FROM provinces
WHERE name = '辽宁省'
  AND country_id = china_id;
INSERT INTO cities (id, name, country, country_id, province_id, region, is_active, created_at)
VALUES (gen_random_uuid(), '沈阳市', 'China', china_id, province_id, '辽宁省', true, CURRENT_TIMESTAMP),
...
WHERE name = '吉林省'
  AND country_id = china_id;
INSERT INTO cities (id, name, country, country_id, province_id, region, is_active, created_at)
VALUES (gen_random_uuid(), '长春市', 'China', china_id, province_id, '吉林省', true, CURRENT_TIMESTAMP),
...
WHERE name = '黑龙江省'
  AND country_id = china_id;
INSERT INTO cities (id, name, country, country_id, province_id, region, is_active, created_at)
VALUES (gen_random_uuid(), '哈尔滨市', 'China', china_id, province_id, '黑龙江省', true, CURRENT_TIMESTAMP),
...
WHERE name = '江苏省'
  AND country_id = china_id;
INSERT INTO cities (id, name, country, country_id, province_id, region, is_active, created_at)
VALUES (gen_random_uuid(), '南京市', 'China', china_id, province_id, '江苏省', true, CURRENT_TIMESTAMP),
...
WHERE name = '浙江省'
  AND country_id = china_id;
INSERT INTO cities (id, name, country, country_id, province_id, region, is_active, created_at)
VALUES (gen_random_uuid(), '杭州市', 'China', china_id, province_id, '浙江省', true, CURRENT_TIMESTAMP),
...
WHERE name = '安徽省'
  AND country_id = china_id;
INSERT INTO cities (id, name, country, country_id, province_id, region, is_active, created_at)
VALUES (gen_random_uuid(), '合肥市', 'China', china_id, province_id, '安徽省', true, CURRENT_TIMESTAMP),
