...
WHERE name = '河北省'
  AND country_id = china_id;
INSERT INTO cities (id, name, country, country_id, province_id, region, is_active, created_at)
VALUES (gen_random_uuid(), '石家庄市', 'China', china_id, province_id, '河北省', true, CURRENT_TIMESTAMP),
...
WHERE name = '山西省'
  AND country_id = china_id;
INSERT INTO cities (id, name, country, country_id, province_id, region, is_active, created_at)
VALUES (gen_random_uuid(), '太原市', 'China', china_id, province_id, '山西省', true, CURRENT_TIMESTAMP),
...
WHERE name = '内蒙古自治区'
  AND country_id = china_id;
INSERT INTO cities (id, name, country, country_id, province_id, region, is_active, created_at)
VALUES (gen_random_uuid(), '呼和浩特市', 'China', china_id, province_id, '内蒙古自治区', true, CURRENT_TIMESTAMP),
