...
public interface IAIChatService
{
    ...
    ///     更新对话
    /// </summary>
    Task<ConversationResponse> UpdateConversationAsync(Guid conversationId, UpdateConversationRequest request,
        Guid userId);
    ...
    ///     发送消息并获取流式AI回复
    /// </summary>
    IAsyncEnumerable<StreamResponse> SendMessageStreamAsync(Guid conversationId, SendMessageRequest request,
        Guid userId);
