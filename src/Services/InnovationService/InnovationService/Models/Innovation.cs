...
public class Innovation : BaseModel
{
    ...
    [Column("demo_url")] public string? DemoUrl { get; set; }

    [Column("github_url")] public string? GithubUrl { get; set; }

    [Column("website_url")] public string? WebsiteUrl { get; set; }

    [Column("team_size")] public int TeamSize { get; set; } = 1;

    [Column("looking_for")] public string[]? LookingFor { get; set; } // co-founder, developer, designer, investor, etc.

    [Column("skills_needed")] public string[]? SkillsNeeded { get; set; }

    [Column("like_count")] public int LikeCount { get; set; } = 0;
