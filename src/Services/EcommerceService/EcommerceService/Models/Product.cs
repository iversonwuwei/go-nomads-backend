...
public class Product : BaseModel
{
    ...
    [Column("stock")] public int Stock { get; set; } = 0;
    ...
    [Column("seller_id")] public Guid? SellerId { get; set; }
...
public class OrderItem : BaseModel
{
    ...
    [Required] [Column("product_price")] public decimal ProductPrice { get; set; }

    [Required] [Column("quantity")] public int Quantity { get; set; }

    [Required] [Column("subtotal")] public decimal Subtotal { get; set; }
