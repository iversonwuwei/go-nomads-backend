...
public class TravelPlan : BaseModel
{
    ...
    [Column("cities")] public Guid[]? Cities { get; set; }
    ...
    [Column("itinerary")] public string? Itinerary { get; set; }
...
public class TravelPlanCollaborator : BaseModel
{
    ...
    [Required] [Column("travel_plan_id")] public Guid TravelPlanId { get; set; }

    [Required] [Column("user_id")] public Guid UserId { get; set; }

    [MaxLength(20)] [Column("role")] public string Role { get; set; } = "viewer"; // owner, editor, viewer
